...
STUDENT_QUALITIES = sys.argv[6]
PROBLEM_SOLVING_SPEED = sys.argv[7]
WORK_AMOUNT = sys.argv[8]
REMARKS = sys.argv[9]
STUDENT_ASSESSMENT = sys.argv[10]
...
context = {"PRACTICE_PLACE": PRACTICE_PLACE, "PRACTICE_PLACE_PRED": PRACTICE_PLACE_PRED, "PRACTICE_PLACE_ADDRESS": PRACTICE_PLACE_ADDRESS, "WORK_YEAR": WORK_YEAR,
           "PRACTICE_DEADLINES": PRACTICE_DEADLINES, "STUDENT_QUALITIES": STUDENT_QUALITIES, "PROBLEM_SOLVING_SPEED": PROBLEM_SOLVING_SPEED, "WORK_AMOUNT": WORK_AMOUNT,
