...
COMPANY_CHIEF_POSITION = sys.argv[11]

INSTITUTE = sys.argv[12]
PRACTICE_DEADLINES = sys.argv[13]
YEAR_WORK = sys.argv[14]
DIRECTION_OF_PREPARATION = sys.argv[15]
STUDENT_QUALITIES = sys.argv[16]
SPEED_OF_PROBLEM_SOLVING = sys.argv[17]
AMOUNT_OF_WORK = sys.argv[18]
OTHER_REMARKS = sys.argv[19]
STUDENT_ASSESSMENT = sys.argv[20]

doc = DocxTemplate("../templates/diary_template.docx")
context = {"PRACTICE_PLACE": PRACTICE_PLACE, "PRACTICE_PLACE_PRED": PRACTICE_PLACE_PRED, "PRACTICE_PLACE_ADDRESS": PRACTICE_PLACE_ADDRESS, "STUDENT_COURSE": STUDENT_COURSE, "STUDENT_GROUP": STUDENT_GROUP, "STUDENT_FULLNAME_ROD": STUDENT_FULLNAME_ROD, "STUDENT_FULLNAME_IMEN": STUDENT_FULLNAME_IMEN, "STUDENT_FULLNAME_DAT": STUDENT_FULLNAME_DAT, "PRACTICE_KIND_IMEN": PRACTICE_KIND_IMEN, "PRACTICE_KIND_DAT": PRACTICE_KIND_DAT, "PRACTICE_KIND_VIN": PRACTICE_KIND_VIN, "ORGANIZATION_CHIEF_FULLNAME": ORGANIZATION_CHIEF_FULLNAME, "ORGANIZATION_CHIEF_POSITION": ORGANIZATION_CHIEF_POSITION, "USU_CHIEF_FULLNAME": USU_CHIEF_FULLNAME, "USU_CHIEF_POSITION": USU_CHIEF_POSITION, "COMPANY_CHIEF_POSITION": COMPANY_CHIEF_POSITION, "INSTITUTE": INSTITUTE, "PRACTICE_DEADLINES": PRACTICE_DEADLINES, "YEAR_WORK": YEAR_WORK, "DIRECTION_OF_PREPARATION": DIRECTION_OF_PREPARATION, "STUDENT_QUALITIES": STUDENT_QUALITIES, "SPEED_OF_PROBLEM_SOLVING": SPEED_OF_PROBLEM_SOLVING, "AMOUNT_OF_WORK": AMOUNT_OF_WORK, "OTHER_REMARKS": OTHER_REMARKS, "STUDENT_ASSESSMENT": STUDENT_ASSESSMENT}
doc.render(context)
