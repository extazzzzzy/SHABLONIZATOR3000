...
WORK_YEAR = sys.argv[14]
PREPARATION_DIRECTION = sys.argv[15]
STUDENT_QUALITIES = sys.argv[16]
PROBLEM_SOLVING_SPEED = sys.argv[17]
WORK_AMOUNT = sys.argv[18]
REMARKS = sys.argv[19]
...
context = {"PRACTICE_PLACE": PRACTICE_PLACE, "PRACTICE_PLACE_PRED": PRACTICE_PLACE_PRED, "PRACTICE_PLACE_ADDRESS":
    ...
    STUDENT_FULLNAME_ROD, "STUDENT_FULLNAME_IMEN": STUDENT_FULLNAME_IMEN, "STUDENT_FULLNAME_DAT": STUDENT_FULLNAME_DAT, "PRACTICE_KIND_IMEN": PRACTICE_KIND_IMEN, "PRACTICE_KIND_DAT": PRACTICE_KIND_DAT, "PRACTICE_KIND_VIN": PRACTICE_KIND_VIN, "ORGANIZATION_CHIEF_FULLNAME": ORGANIZATION_CHIEF_FULLNAME, "ORGANIZATION_CHIEF_POSITION": ORGANIZATION_CHIEF_POSITION, "USU_CHIEF_FULLNAME": USU_CHIEF_FULLNAME, "USU_CHIEF_POSITION": USU_CHIEF_POSITION, "COMPANY_CHIEF_POSITION": COMPANY_CHIEF_POSITION, "INSTITUTE": INSTITUTE, "PRACTICE_DEADLINES": PRACTICE_DEADLINES, "WORK_YEAR": WORK_YEAR, "PREPARATION_DIRECTION": PREPARATION_DIRECTION, "STUDENT_QUALITIES": STUDENT_QUALITIES, "PROBLEM_SOLVING_SPEED": PROBLEM_SOLVING_SPEED, "WORK_AMOUNT": WORK_AMOUNT, "REMARKS": REMARKS, "STUDENT_ASSESSMENT": STUDENT_ASSESSMENT}
doc.render(context)
