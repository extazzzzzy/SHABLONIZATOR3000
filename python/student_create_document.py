...
context = {"PRACTICE_KIND_IMEN": PRACTICE_KIND_IMEN, "PRACTICE_KIND_DAT": PRACTICE_KIND_DAT, "PRACTICE_KIND_VIN":
    ...
    STUDENT_FULLNAME_IMEN, "STUDENT_FULLNAME_ROD": STUDENT_FULLNAME_ROD, "STUDENT_FULLNAME_DAT": STUDENT_FULLNAME_DAT, "INSTITUTE": INSTITUTE, "PREPARATION_DIRECTION": PREPARATION_DIRECTION, "USU_CHIEF_FULLNAME": USU_CHIEF_FULLNAME, "USU_CHIEF_POSITION": USU_CHIEF_POSITION}
doc1.render(context)
