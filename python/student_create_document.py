...
context = {"PRACTICE_KIND_IMEN": PRACTICE_KIND_IMEN, "PRACTICE_KIND_DAT": PRACTICE_KIND_DAT, "PRACTICE_KIND_VIN":
    ...
    STUDENT_FULLNAME_IMEN, "STUDENT_FULLNAME_ROD": STUDENT_FULLNAME_ROD,
           ...
           "USU_CHIEF_FULLNAME": USU_CHIEF_FULLNAME, "USU_CHIEF_POSITION": USU_CHIEF_POSITION, "TASKS": tasks, "ORGANIZATION_CHIEF_FULLNAME": ORGANIZATION_CHIEF_FULLNAME,
           "ORGANIZATION_CHIEF_POSITION": ORGANIZATION_CHIEF_POSITION,


           "PRACTICE_PLACE": "{{PRACTICE_PLACE}}", "PRACTICE_PLACE_PRED": "{{PRACTICE_PLACE_PRED}}", "WORK_YEAR": "{{WORK_YEAR}}",
